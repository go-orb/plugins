...
require (
	...
	github.com/go-orb/plugins/client/orb v0.0.0-20241027043739-772da474b6a7
	github.com/go-orb/plugins/client/orb/transport/basehertz v0.0.0-20241027043739-772da474b6a7
)
