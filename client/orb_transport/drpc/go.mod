...
require (
	...
	github.com/go-orb/plugins/client/tests v0.3.0
...
require (
	...
	github.com/go-orb/plugins/server/http v0.2.0 // indirect
	github.com/go-orb/plugins/server/memory v0.1.0 // indirect
