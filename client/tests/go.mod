...
require (
	...
	github.com/go-orb/plugins/config/source/cli/urfave v0.0.0-20231126232626-f2cd47f2724d
	github.com/go-orb/plugins/config/source/file v0.0.0-20231126232626-f2cd47f2724d
	github.com/go-orb/plugins/log/lumberjack v0.0.0-20231126232626-f2cd47f2724d
	...
	github.com/go-orb/plugins/server/grpc v0.0.0-20231126232626-f2cd47f2724d
