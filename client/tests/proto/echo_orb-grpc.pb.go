...
const (
	...
	Streams_AuthorizedCall_FullMethodName = "/echo.Streams/AuthorizedCall"
)
...
func (UnimplementedStreamsServer) AuthorizedCall(context.Context, *CallRequest) (*CallResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AuthorizedCall not implemented")
}
...
func _Streams_AuthorizedCall_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CallRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StreamsServer).AuthorizedCall(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Streams_AuthorizedCall_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StreamsServer).AuthorizedCall(ctx, req.(*CallRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Streams_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AuthorizedCall",
			Handler:    _Streams_AuthorizedCall_Handler,
		},
	},
