...
require (
	...
	github.com/go-orb/plugins/codecs/proto v0.1.1-0.20250307101622-0ab743aa8529
	github.com/go-orb/plugins/event/natsjs v0.1.1-0.20250307101622-0ab743aa8529
