...
var _ (server.Entrypoint) = (*EntrypointMock)(nil)
...
func NewDefaultMockConfig() server.EntrypointConfig {
	cfg := ConfigMock{
...
func (c ConfigMock) Copy() server.EntrypointConfig {
	return &c
}
...
func WithInvalidEntrypoint() server.Option {
	return func(c *server.Config) {
		c.Templates["invalid-"+uuid.NewString()] = server.EntrypointTemplate{
			Enabled: true,
			Type:    "fake",
			Config:  nil,
		}
...
func WithInvalidConfigEntrypoint() server.Option {
	return func(c *server.Config) {
		c.Templates["invalid-"+uuid.NewString()] = server.EntrypointTemplate{
			Enabled: true,
			Type:    "mock-two",
...
func WithMockEntrypoint(options ...MockOption) server.Option {
	return func(c *server.Config) {
...
func WithMockDefaults(opts ...MockOption) server.Option {
	return func(c *server.Config) {
